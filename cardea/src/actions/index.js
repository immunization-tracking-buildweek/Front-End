...
export const authUsersRegister = (patientRegister, props) => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the success console.log in index.js - user_register`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - user_register`,
        err
      );
...
export const authMedRegister = (medProfRegister, props) => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the success console.log in index.js - med_register`,
        res.data
      );
...
export const authMedLogin = (medProfLogin, props) => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the initial console.log in index.js - med_login`,
        res
      );
...
export const getUserInfo = (user_id, props) => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the login console.log in index.js - get_user_info`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - get_user_info`,
        err
      );
...
export const getPatientInfo = props => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the login console.log in index.js - get_patient_info`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - get_patient_info`,
        err
      );
...
export const addNewPatient = (body) => dispatch => {
  ...
  axiosWithAuth()
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - add_new_patient`,
        err
      );
...
export const editPatient = (editPatientProps, props) => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the login console.log in index.js - edit_patient`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - edit_patient`,
        err
      );
...
export const deletePatient = props => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the login console.log in index.js - delete_patient`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - delete_patient`,
        err
      );
...
export const givePermission = (givePermissionProps, props) => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the login console.log in index.js - give_permission`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - give_permission`,
        err
      );
...
export const editPermission = (editPermissionProps, props) => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the login console.log in index.js - edit_permission`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - edit_permission`,
        err
      );
...
export const getPermissionStatus = props => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the login console.log in index.js - get_permission_status`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - get_permission_status`,
        err
      );
...
export const medGetUserInfo = (med_id, props) => dispatch => {
  ...
  axiosWithAuthMed()
    ...
    .then(res => {
      console.log(
        `This is the login console.log in index.js - med_get_user_info`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - med_get_user_info`,
        err
      );
...
export const deleteImmunization = props => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the initial console.log in index.js - delete_immunization`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - delete_immunization`,
        err
      );
...
export const getImmunizationInfo = props => dispatch => {
  ...
  axiosWithAuth()
    ...
    .then(res => {
      console.log(
        `This is the login console.log in index.js - get_immunization_info`,
        res
      );
    ...
    .catch(err => {
      console.log(
        `This is the failure console.log in index.js - get_immunization_info`,
        err
      );
